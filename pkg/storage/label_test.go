...
func TestMarshalMetricName(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: "\x00\ametric1\x00@aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\x01\x00",
		},
	}
