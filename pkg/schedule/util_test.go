...
func Test_formatTime(t *testing.T) {
	...
	_, _, _, err = formatTime("24:59:59")
	assert.NotNil(err)
	_, _, _, err = formatTime("23:59:59:11")
	assert.NotNil(err)
	_, _, _, err = formatTime("er")
	assert.NotNil(err)
	_, _, _, err = formatTime("11")
	assert.NotNil(err)
	_, _, _, err = formatTime("aa:59:59")
	assert.NotNil(err)
	_, _, _, err = formatTime("1:a:59")
	assert.NotNil(err)
	_, _, _, err = formatTime("1:11:a")
	assert.NotNil(err)

	_, _, _, err = formatTime("23:59:59.323")
	assert.NotNil(err)
}
